...
<body>
	...
	<div class="container text-center">
		...
		<div class="btn-group" role="group" aria-label="Basic outlined example">
			<button type="button" class="btn btn-outline-primary" onclick="window.location.href='indexclinica.jsp'">Clinica</button>
			<button type="button" class="btn btn-outline-primary" onclick="window.location.href='indexcliente.jsp'">Cliente</button>
		</div>
	</div>
